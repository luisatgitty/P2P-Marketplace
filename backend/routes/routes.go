...
func AppRoutes(app *fiber.App) {
	...
	app.Post("/profile/me/verification", controller.AuthenticateUser, controller.SubmitMeVerification)
	app.Delete("/profile/me", controller.AuthenticateUser, controller.DeactivateMeProfile)
	app.Get("/admin/dashboard/stats", controller.AuthenticateUser, controller.GetAdminDashboardStats)
	...
	app.Get("/admin/admins", controller.AuthenticateUser, controller.GetAdminAccounts)
	app.Post("/admin/admins", controller.AuthenticateUser, controller.CreateAdminAccount)
	app.Patch("/admin/admins/:id/active", controller.AuthenticateUser, controller.SetAdminAccountActive)
	app.Delete("/admin/admins/:id", controller.AuthenticateUser, controller.DeleteAdminAccount)
	...
	app.Get("/admin/reports", controller.AuthenticateUser, controller.GetAdminReports)
	app.Patch("/admin/reports/:id/status", controller.AuthenticateUser, controller.SetAdminReportStatus)
