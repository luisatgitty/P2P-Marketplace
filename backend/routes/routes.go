...
func AppRoutes(app *fiber.App) {
	...
	app.Patch("/listing/:id/mark-complete", controller.AuthenticateUser, controller.MarkListingAsComplete)
	...
	app.Get("/admin/transactions", controller.AuthenticateUser, controller.GetAdminTransactions)
	app.Patch("/admin/listings/:id/toggle-visibility", controller.AuthenticateUser, controller.ToggleAdminListingVisibility)
	...
	app.Get("/admin/verifications", controller.AuthenticateUser, controller.GetAdminVerifications)
	app.Patch("/admin/verifications/:id/status", controller.AuthenticateUser, controller.SetAdminVerificationStatus)
	...
	app.Get("/notifications", controller.AuthenticateUser, controller.GetNotifications)
	app.Patch("/notifications/read-all", controller.AuthenticateUser, controller.MarkAllNotificationsRead)
	app.Patch("/notifications/:id/read", controller.AuthenticateUser, controller.MarkNotificationRead)
