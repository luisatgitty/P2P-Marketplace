...
const SUGGESTIONS = [
  ...
  },
  {
    ...
    hover:
      'hover:border-teal-400 dark:hover:border-teal-600 hover:bg-teal-50 dark:hover:bg-teal-950/50',
  },
  {
    label: 'Services',
    ...
    hover:
      'hover:border-violet-400 dark:hover:border-violet-600 hover:bg-violet-50 dark:hover:bg-violet-950/50',
  },
];
