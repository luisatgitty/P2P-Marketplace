...
const VERIFICATIONS: AdminVerification[] = [
  {
    id: "v1",
    user_id: "u1",
    user_name: "Juan Miguel Dela Cruz",
    ...
    reviewed_by: null,
    reviewed_at: null,
    submitted_at: "Mar 19, 2026 · 8:00 AM",
  },
  {
    id: "v2",
    user_id: "u2",
    user_name: "Maria Cristina Santos",
    ...
    reviewed_by: null,
    reviewed_at: null,
    submitted_at: "Mar 18, 2026 · 4:30 PM",
  },
  {
    id: "v3",
    user_id: "u7",
    user_name: "Ramon Torres",
    user_email: "ramon@email.com",
    id_type: "Driver's License",
    id_number: "N07-89-012345",
    status: "PENDING",
    rejection_reason: null,
    reviewed_by: null,
    reviewed_at: null,
    submitted_at: "Mar 17, 2026 · 2:00 PM",
  },
  {
    id: "v4",
    user_id: "u3",
    user_name: "Pedro Jose Reyes",
    user_email: "pedro@email.com",
    id_type: "SSS ID",
    id_number: "34-1234567-8",
    status: "VERIFIED",
    rejection_reason: null,
    reviewed_by: "Admin One",
    reviewed_at: "Mar 15, 2026",
    submitted_at: "Mar 12, 2026 · 10:00 AM",
  },
  {
    id: "v5",
    user_id: "u4",
    user_name: "Ana Liza Bautista",
    user_email: "ana@email.com",
    id_type: "Voter's ID",
    id_number: "1234-56-789-0123",
    status: "VERIFIED",
    rejection_reason: null,
    reviewed_by: "Admin One",
    reviewed_at: "Mar 10, 2026",
    submitted_at: "Mar 7, 2026 · 9:00 AM",
  },
  {
    id: "v6",
    user_id: "u6",
    user_name: "Luisa Mae Garcia",
    user_email: "luisa@email.com",
    id_type: "PhilSys ID",
    id_number: "9876-5432-1098",
    status: "REJECTED",
    rejection_reason:
      "Uploaded ID image is blurry and cannot be verified. Selfie does not clearly show the ID. Please resubmit with clearer photos.",
    reviewed_by: "Admin One",
    reviewed_at: "Mar 18, 2026",
    submitted_at: "Mar 16, 2026 · 11:00 AM",
  },
];
      ...
      <div className="bg-white dark:bg-[#1c1f2e] rounded-t-3xl sm:rounded-2xl w-full sm:max-w-lg shadow-2xl flex flex-col max-h-[90vh]">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-5">
          ...
          <div className="flex items-center gap-3 p-4 bg-stone-50 dark:bg-[#13151f] rounded-xl border border-stone-200 dark:border-[#2a2d3e]">
            ...
            <span
              className={cn(
                "ml-auto text-[10px] font-bold px-2 py-0.5 rounded-full flex items-center gap-1",
                sc.cls,
              )}
            >
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="bg-stone-50 dark:bg-[#13151f] rounded-xl p-3 border border-stone-200 dark:border-[#2a2d3e]">
                ...
                <p className="text-sm font-bold text-stone-800 dark:text-stone-100 font-mono">
                  {verif.id_number}
                </p>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-2">
              {["ID — Front", "ID — Back", "Selfie with ID"].map((label) => (
                ...
                >
                  ...
                  <span className="text-[10px] text-stone-400 dark:text-stone-500 text-center px-1">
                    {label}
                  </span>
                </div>
              ))}
            ...
            <p className="text-[10px] text-stone-400 dark:text-stone-500 mt-2">
              Click any image to view full size · Images served from secure
              storage
            </p>
          </div>
      ...
      rs.map((r) =>
        r.id === id
          ? {
              ...
              status: "VERIFIED",
              reviewed_by: "Admin One",
              reviewed_at: new Date().toLocaleDateString("en-PH", {
                month: "short",
                day: "numeric",
                year: "numeric",
              }),
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="py-3.5 px-4 text-xs text-stone-500 dark:text-stone-400 whitespace-nowrap">
                        {verif.reviewed_by ? (
                          <span>
                            {verif.reviewed_by} · {verif.reviewed_at}
                          </span>
                        ) : (
