      ...
      {dialog && (
        <>
          ...
          <div className="fixed inset-0 z-1000 flex items-center justify-center p-4">
            <div
              className={cn(
                "w-full max-w-sm rounded-2xl border border-stone-200 dark:border-[#2a2d3e] bg-white dark:bg-[#1c1f2e] shadow-2xl transition-all duration-150",
                isClosing
                  ? "opacity-0 scale-95"
            ...
            >
              ...
              {/* Footer */}
              <div className="flex items-center justify-end gap-3 px-6 py-4 border-t border-stone-200 dark:border-[#2a2d3e] bg-stone-50 dark:bg-[#13151f] rounded-b-2xl">
                <button
                  onClick={handleCancel}
