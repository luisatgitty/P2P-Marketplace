...
interface ReportActionsModalProps {
  report:    AdminReport;
  onClose:   () => void;
  onSubmit:  (reportId: string, action: ReportActionType, reason: string) => Promise<void> | void;
}
...
const SEVERITY_STYLES: Record<ActionOption["severity"], {
  idle:     string;
  selected: string;
  dot:      string;
}> = {
  low: {
    ...
    selected: "border-teal-400 dark:border-teal-500 bg-teal-50 dark:bg-teal-950/30 ring-1 ring-teal-400/40",
    dot:      "bg-teal-500",
  },
  medium: {
    idle:     "border-stone-200 dark:border-[#2a2d3e] hover:border-amber-300 dark:hover:border-amber-700",
    selected: "border-amber-400 dark:border-amber-500 bg-amber-50 dark:bg-amber-950/30 ring-1 ring-amber-400/40",
    dot:      "bg-amber-500",
  },
  high: {
    idle:     "border-stone-200 dark:border-[#2a2d3e] hover:border-orange-300 dark:hover:border-orange-700",
    selected: "border-orange-400 dark:border-orange-500 bg-orange-50 dark:bg-orange-950/30 ring-1 ring-orange-400/40",
    dot:      "bg-orange-500",
  },
  critical: {
    idle:     "border-stone-200 dark:border-[#2a2d3e] hover:border-red-300 dark:hover:border-red-700",
    selected: "border-red-400 dark:border-red-500 bg-red-50 dark:bg-red-950/30 ring-1 ring-red-400/40",
    dot:      "bg-red-500",
  },
};
