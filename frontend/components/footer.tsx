const TwitterIcon  = () => (<svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.737-8.835L1.254 2.25H8.08l4.253 5.622 5.91-5.622zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>);
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col gap-6">
            ...
            <div className="flex items-center gap-2 mb-3">
              <div className="w-8 h-8 bg-stone-100 rounded-lg flex items-center justify-center">
                <svg className="w-4 h-4 text-stone-800" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13l-1.5 6h13M7 13l-1-4h12" />
                </svg>
              </div>
          ...
          <nav className="flex flex-wrap gap-x-6 gap-y-2">
            {LINKS.map((link) => (
              <a key={link} href="#" className="text-stone-400 text-sm hover:text-stone-100 transition-colors whitespace-nowrap">
                {link}
              </a>
            ))}
          </nav>
